...
| `EventBus` | Core/event_bus_celery.py | 模块级变量 | Celery Worker 事件管理 |
| `MongoClientManager` | DataStore/mongo_client.py | `@singleton` | MongoDB 连接管理 |
| `RedisClientManager` | Cache/redis_conn.py | `@singleton` | Redis 连接管理 |
