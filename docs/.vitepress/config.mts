      ...
      '/fqbase/': {
        ...
        items: [
          ...
          { text: 'Foundation 基础组件', items: [
            ...
            { text: 'exceptions 异常', link: 'foundation/exceptions/README' },
          ...
          { text: 'Core 核心服务', items: [
            { text: 'core 概览', link: 'core/README' },
            { text: 'eventbus 事件总线', link: 'core/event_bus/README' },
            { text: 'event_bus_celery Celery集成', link: 'core/event_bus_celery/README' },
          ...
          { text: 'Cache 缓存层', items: [
            { text: 'cache 概览', link: 'cache/README' },
          ]},
          { text: 'DataStore 数据存储', items: [
            { text: 'datastore 概览', link: 'datastore/README' },
            { text: 'mongo_client Mongo客户端', link: 'datastore/mongo_client/README' },
            { text: 'mongo_db Mongo数据库', link: 'datastore/mongo_db/README' },
          ]},
          { text: 'Date 日期工具', items: [
            { text: 'date 概览', link: 'date/README' },
            { text: 'timestamp 时间戳', link: 'date/timestamp' },
            { text: 'trade 交易日', link: 'date/trade' },
          ]},
          { text: 'Crawler 爬虫', items: [
            { text: 'crawler 概览', link: 'crawler/README' },
            { text: 'browser 浏览器', link: 'crawler/browser/README' },
          ]},
          { text: 'Util 工具库', items: [
            { text: 'util 概览', link: 'util/README' },
            { text: 'bar K线工具', link: 'util/bar' },
            { text: 'codec 编解码', link: 'util/codec' },
            { text: 'converters 转换器', link: 'util/converters' },
            { text: 'crypto 加密', link: 'util/crypto' },
